...
$sql_1 = "SELECT *, p.id AS id, p.property_name AS property_name, c.city_name AS city_name 
            FROM properties p
            INNER JOIN cities c ON p.id = c.id 
...
$sql_4 = "SELECT * FROM interested_users_properties WHERE id = $property_id";
...
<body>
    ...
    <div class="property-summary page-container">
        <div class="row no-gutters justify-content-between">
            <?php
            $total_rating = ($property['rating_cleaniness'] + $property['rating_food'] + $property['rating_safety']) / 3;
        ...
        <div class="detail-container">
            ...
            <div class="property-address"><?= $property['property_adresss'] ?></div>
                ...
                <div class="col-md-auto">
                    ...
                    ?>
                            <div class="amenity-container">
                                ...
                                <span><?= $amenity['ameneties_name'] ?></span>
                            </div>
                    <?php
                        }
                    }
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6">
                    <div class="rating-criteria row">
                        ...
                        <div class="rating-criteria-star-container col-6" title="<?= $property['rating_cleaniness'] ?>">
                            <?php
                            $rating = $property['rating_cleaniness'];
                            for ($i = 0; $i < 5; $i++) {
                                if ($rating >= $i + 0.8) {
                            ?>
                                    <i class="fas fa-star"></i>
    ...
    <?php
    include "includes/sign_up_modal.php";
