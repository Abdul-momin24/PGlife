...
$sql_1 ="SELECT * FROM intersted_users_properties WHERE user_id =$user_id AND property_id =$property_id";

$result_1 = mysqli_query($conn, $sql_1);
// We are checking whether entry databse present hai ki nahi
if(! $result_1){
    echo json_encode(array("success" => false, "message" => "Something went wrong!"));
    return;
}
// Agr property liked hai to hum disliked ka function describe kr rhe
